 ...
 * @type {String}
 *
 * @properties={typeid:35,uuid:"04fde543-89cc-4de9-af47-7f7c22221f18",variableType:12}
 */
...
function ADD_platform(event) {
	...
	if (fsPlatform.getSize() == fsPlatformAll.getSize()) {
		...
		var refTab = forms.WEB_0F_page__design_1F__header_display.elements.tab_platform
