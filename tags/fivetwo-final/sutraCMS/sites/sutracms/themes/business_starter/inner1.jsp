...
<link href="common/css/style.css" type="text/css" rel="stylesheet" media="screen" />
<link href="common/fonts/stylesheet.css" rel="stylesheet" type="text/css" />
...
<!--banner starts-->
  <div id="banner2">
    ...
    <ul id="slider1">
      <li><img width="951px" height="200px" src="common/images/banner1.jpg" alt=""/>
        <div class="info">
  ...
  <div id="body_container">
    <div id="body_nav" >
      <ul>
        ...
        <li class="last"><a class="active" href="">Heading</a></li>
      </ul>
    </div>
    <div class="left_container">
      <div class="inner">
        ...
        <div class="body_bottom">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer semper egestas nunc in volutpat. Fusce adipiscing velit ac eros tempor iaculis. Phasellus venenatis mollis augue, non </p>
        </div>
      </div>
    </div>
    <div class="right_container">
      <ul id="content2_right">
        <li class="news">
          ...
          <p class="business2">Lorem ipsum dolor sit amet, mi lacus luctus, etiam dui quisque placerat. Tortor nec. Posuere quisque rutrum vivamus vulputate quis, pretium viverra augue luctus volutpat, sollicitudin nibh sit, amet wisi quis suspendisse massa, magna. </p>
        </li>
        <li class="reports"> <small><img src="common/images/istock_photo.jpg" alt="istock photo" /></small>
          <p>Health and Safety Standards Report August, 2010</p>
          <a href="#">Read more</a> </li>
        <li class="last">
          <h5>Dummy Headline </h5>
          <a href="#">Lorem ipsum dolor sit cras</a> </li>
      </ul>
    </div>
  </div>
  <!--body_container ends-->
